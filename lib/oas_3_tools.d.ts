 ...
 */
export declare function getSchemaType(
  schema: SchemaObject,
 ...
 * does not exist.
 */
export declare function getRequestBodyObject(
 ...
 * does not exist.
 */
export declare function getResponseObject(
  endpoint: OperationObject,
  statusCode: string,
  oas: Oas3
): {
 ...
 * the given mapping.
 */
export declare function sanitizeAndStore(
  str: string,
  mapping: {
    [key: string]: string;
  }
 ...
 */
export declare function formatOperationString(
  method: string,
  path: string,
  title?: string
): string;
