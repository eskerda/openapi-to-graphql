...
function createGraphQlSchema(spec, options) {
  return __awaiter(this, void 0, void 0, function*() {
    ...
    options.viewer =
      typeof options.viewer === "boolean" ? options.viewer : true;
...
function translateOpenApiToGraphQL(
  ...
  return __awaiter(this, void 0, void 0, function*() {
    ...
    if (Object.keys(authQueryFields).length > 0) {
      Object.assign(
        queryFields,
        auth_builder_1.createAndLoadViewer(authQueryFields, data, false)
      );
    }
    if (Object.keys(authMutationFields).length > 0) {
      Object.assign(
        mutationFields,
        auth_builder_1.createAndLoadViewer(authMutationFields, data, true)
      );
    }
    /**
     * Build up the schema
